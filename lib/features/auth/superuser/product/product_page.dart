...
class _ProductPageState extends ConsumerState<ProductPage> {
  ...
  Widget _stockBox(String label, String value, Color c, IconData icon) => Container(
    ...
    child: Column(children: [
      ...
      Text(value, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: c)), // 16px
    ]),
  );
          ...
          return Column(children: [
            Container(color: Colors.white, padding: const EdgeInsets.fromLTRB(12,12,12,8),
              child: TextField(controller: _searchCtrl, onChanged: _onSearchChanged,
                decoration: InputDecoration(hintText: 'Cari Perkakas / SKU / Brand...', prefixIcon: const Icon(Icons.search, color: Color(0xFF00A65A)),
...
// FORM TETAP SAMA BOS, TIDAK UBAH
