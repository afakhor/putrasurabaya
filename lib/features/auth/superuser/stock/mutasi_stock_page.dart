...
final allStockMutationsStreamProvider = StreamProvider.family<List<StockCardItemData>, Map<String, dynamic>>((ref, filter) {
  ...
  return db.stockMutationDao.watchAllStockMutations(mutationTypeFilter: filter['type'] as String?, keyword: filter['keyword'] as String?);
});
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Expanded(child: mutasi.when(
          data: (list){
            if(list.isEmpty) return const Center(child: Text('Belum ada mutasi'));
