...
class _RakitState extends ConsumerState<PerakitanPage> {
  ...
  Future<ProductData?> _getProduct(String id) async {
    return await ref.read(productDaoProvider).getProductById(id);
  }
        ...
        ElevatedButton(
          onPressed: () async { 
            ...
            if(id!=null){ 
              ...
              setState((){ jadiId=id; jadiName=p?.name; }); 
            } 
          }, 
          ...
          IconButton(
            ...
            onPressed: () async { 
              ...
              if(id!=null){ 
                ...
                if(ok==true) {
                  setState(()=> bahan.add({'productId':id, 'name':p?.name, 'qty':double.tryParse(qtyC.text)??1}));
                }
              } 
            }
          )
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            onPressed: () async {
              ...
              try {
                await ref.read(stockMutationDaoProvider).eksekusiPerakitanProduk(
                ...
                if(mounted){ 
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Rakit OK - HPP jadi = total HPP bahan'))); 
