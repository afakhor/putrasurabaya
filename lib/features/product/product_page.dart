  ...
  @override Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        Row(children: [Expanded(child: DropdownButtonFormField<String>(value: state.statusActive, items: const [DropdownMenuItem(value: 'aktif', child: Text('Aktif Dijual')), DropdownMenuItem(value: 'nonaktif', child: Text('Non-Aktif / Arsip'))], onChanged: (v) => notifier.updateField(statusActive: v!), decoration: const InputDecoration(labelText: 'Status Produk', border: OutlineInputBorder()))), const SizedBox(width: 8), Expanded(child: TextFormField(initialValue: state.locationRack?? '', decoration: const InputDecoration(labelText: 'Rak / Gudang', border: OutlineInputBorder()), onChanged: (v) => notifier.updateField(locationRack: v)))]),
