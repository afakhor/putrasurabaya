...
class AppThemes {
  ...
  // 3-7 TEMA VIRAL LAMA
  static final aurora = AppTheme(name: 'Aurora Borealis', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent, brightness: Brightness.dark), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFF0F172A), blobs: const [_BlobData(top: -100, left: -80, size: 500, color: Color(0xFF7C3AED)), _BlobData(top: 100, right: -100, size: 450, color: Color(0xFF06B6D4)), _BlobData(bottom: -80, left: 20, size: 500, color: Color(0xFFEC4899))], child: child));
  static final sunset = AppTheme(name: 'Sunset Sorbet', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFFFF7ED), blobs: const [_BlobData(top: -120, left: -50, size: 450, color: Color(0xFFFF8A65)), _BlobData(top: 200, right: -80, size: 400, color: Color(0xFFFFB74D)), _BlobData(bottom: -100, left: -50, size: 450, color: Color(0xFFF48FB1))], child: child));
  static final midnight = AppTheme(name: 'Midnight Galaxy', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent, brightness: Brightness.dark), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFF020617), blobs: const [_BlobData(top: -100, left: -100, size: 500, color: Color(0xFF1E3A8A)), _BlobData(bottom: -120, right: -80, size: 550, color: Color(0xFF581C87)), _BlobData(top: 300, left: 50, size: 300, color: Color(0xFF0E7490))], child: child));
  static final sakura = AppTheme(name: 'Sakura Blush', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFFFF1F2), blobs: const [_BlobData(top: -80, left: -60, size: 400, color: Color(0xFFFDA4AF)), _BlobData(top: 150, right: -60, size: 380, color: Color(0xFFF0ABFC)), _BlobData(bottom: -80, left: -20, size: 450, color: Color(0xFFBAE6FD))], child: child));
  static final mocha = AppTheme(name: 'Mocha Mousse', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFEFEBE9), blobs: const [_BlobData(top: -100, left: -80, size: 450, color: Color(0xFFA18072)), _BlobData(bottom: -80, right: -80, size: 400, color: Color(0xFFD7CCC8)), _BlobData(top: 200, left: 100, size: 250, color: Color(0xFFFFCC80))], child: child));

  // 8-20 TEMA VIRAL BARU 2025-2026
  static final liquidGlass = AppTheme(name: 'Liquid Glass iOS 26', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFF8FAFC), blobs: const [_BlobData(top: -120, left: -100, size: 500, color: Color(0xFF38BDF8)), _BlobData(top: 0, right: -120, size: 480, color: Color(0xFFA78BFA)), _BlobData(bottom: -120, left: 0, size: 550, color: Color(0xFFFB7185))], child: child));

  static final matchaLatte = AppTheme(name: 'Matcha Latte', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFF1F8E9), blobs: const [_BlobData(top: -80, left: -60, size: 420, color: Color(0xFFAED581)), _BlobData(bottom: -100, right: -60, size: 460, color: Color(0xFF8D6E63)), _BlobData(top: 250, right: 20, size: 220, color: Color(0xFFFFF9C4))], child: child));

  static final barbieCore = AppTheme(name: 'Barbiecore', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFFFF0F6), blobs: const [_BlobData(top: -100, left: -70, size: 450, color: Color(0xFFFF1493)), _BlobData(bottom: -90, right: -70, size: 480, color: Color(0xFFDA70D6)), _BlobData(top: 200, left: 80, size: 200, color: Color(0xFFFFB6C1))], child: child));

  static final nordicFrost = AppTheme(name: 'Nordic Frost', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFECEFF1), blobs: const [_BlobData(top: -100, left: -80, size: 500, color: Color(0xFF90A4AE)), _BlobData(top: 150, right: -80, size: 400, color: Color(0xFFB0BEC5)), _BlobData(bottom: -80, left: 30, size: 450, color: Color(0xFFCFD8DC))], child: child));

  static final tangerine = AppTheme(name: 'Tangerine Dream', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFFFF3E0), blobs: const [_BlobData(top: -120, left: -50, size: 460, color: Color(0xFFFF6F00)), _BlobData(top: 100, right: -80, size: 380, color: Color(0xFFFFCA28)), _BlobData(bottom: -100, left: -30, size: 440, color: Color(0xFFFF8A65))], child: child));

  static final lavenderHaze = AppTheme(name: 'Lavender Haze', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFF3E8FF), blobs: const [_BlobData(top: -100, left: -60, size: 450, color: Color(0xFFC084FC)), _BlobData(top: 180, right: -60, size: 400, color: Color(0xFFF0ABFC)), _BlobData(bottom: -90, left: 20, size: 460, color: Color(0xFF93C5FD))], child: child));

  static final forestDew = AppTheme(name: 'Forest Dew', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFE8F5E9), blobs: const [_BlobData(top: -90, left: -70, size: 480, color: Color(0xFF66BB6A)), _BlobData(bottom: -100, right: -70, size: 500, color: Color(0xFF26A69A)), _BlobData(top: 200, left: 40, size: 250, color: Color(0xFFDCEDC8))], child: child));

  static final cyberLime = AppTheme(name: 'Cyber Lime', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent, brightness: Brightness.dark), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFF101412), blobs: const [_BlobData(top: -110, left: -80, size: 500, color: Color(0xFFD4FF32)), _BlobData(bottom: -110, right: -80, size: 520, color: Color(0xFF00E5CC)), _BlobData(top: 250, left: 60, size: 220, color: Color(0xFF76FF03))], child: child));

  static final strawberryMilk = AppTheme(name: 'Strawberry Milk', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFFFEBEE), blobs: const [_BlobData(top: -80, left: -60, size: 430, color: Color(0xFFFF8A80)), _BlobData(bottom: -90, right: -50, size: 450, color: Color(0xFFFFCCBC)), _BlobData(top: 200, right: 30, size: 200, color: Color(0xFFFFF9C4))], child: child));

  static final oceanBreeze = AppTheme(name: 'Ocean Breeze', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFE0F7FA), blobs: const [_BlobData(top: -100, left: -70, size: 480, color: Color(0xFF4FC3F7)), _BlobData(bottom: -100, right: -70, size: 500, color: Color(0xFF26C6DA)), _BlobData(top: 180, left: 50, size: 240, color: Color(0xFFB2EBF2))], child: child));

  static final desertSand = AppTheme(name: 'Desert Sand', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFFAF3E0), blobs: const [_BlobData(top: -100, left: -60, size: 450, color: Color(0xFFD8B48C)), _BlobData(bottom: -100, right: -60, size: 470, color: Color(0xFFE2725B)), _BlobData(top: 250, left: 80, size: 200, color: Color(0xFFF6EAC2))], child: child));

  static final bubblegum = AppTheme(name: 'Bubblegum Sky', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFFCE4EC), blobs: const [_BlobData(top: -90, left: -60, size: 440, color: Color(0xFF81D4FA)), _BlobData(top: 120, right: -60, size: 400, color: Color(0xFFF48FB1)), _BlobData(bottom: -80, left: 20, size: 460, color: Color(0xFFCE93D8))], child: child));

  static final oliveMinimal = AppTheme(name: 'Olive Minimal', themeData: ThemeData(useMaterial3: true, fontFamily: 'Poppins', scaffoldBackgroundColor: Colors.transparent), backgroundBuilder: ({required child}) => _MeshWrapper(baseColor: const Color(0xFFF4F1EA), blobs: const [_BlobData(top: -100, left: -80, size: 450, color: Color(0xFF9CA986)), _BlobData(bottom: -100, right: -80, size: 460, color: Color(0xFFD6D0C0)), _BlobData(top: 200, left: 60, size: 220, color: Color(0xFFEDE8D0))], child: child));

  static List<AppTheme> get allThemes => [
    blendedBright, goldenGreen, aurora, sunset, midnight, sakura, mocha,
    liquidGlass, matchaLatte, barbieCore, nordicFrost, tangerine,
    lavenderHaze, forestDew, cyberLime, strawberryMilk, oceanBreeze,
    desertSand, bubblegum, oliveMinimal
  ];
}
