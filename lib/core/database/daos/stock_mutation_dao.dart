...
class StockMutationDao extends DatabaseAccessor<LocalDatabase> with _$StockMutationDaoMixin {
  ...
  Future<void> _coreMutation({
    ...
    await into(stockMutations).insert(StockMutationsCompanion.insert(
      ...
      currentStockSnapshot: Value(sesudah), referenceNo: refNo, date: date,
  ...
  Future<void> _executeMutation({required String productId, required String type, required double qtyPerubahan, required double hargaBeliMasuk, required String refNo, required String userId, String? notes, DateTime? customDate, String? newRack, String? variantId, bool skipAntiMinus = false}) async {
