...
class CustomerDao extends DatabaseAccessor<LocalDatabase> with _$CustomerDaoMixin {
  ...
  Future<String> createCustomerFull({
    required String name, String? phone, String? wa, String? address, String? kota,
    String kelas = 'Retail', String paymentType = 'Tunai', String tierHarga = 'Umum',
  }) async {
